...
public class MoviesController : Controller
{
    ...
    public async Task<IActionResult> Index(string movieGenre, string searchString, string movieRating, bool isAjax = false)
    {
        ...
        var movieGenreVM = new MovieGenreViewModel
        {
            ...
            Ratings = new SelectList(await ratingQuery.Distinct().ToListAsync()), // Pass ratings to the view model
            Movies = await movies.ToListAsync(),
            MovieGenre = movieGenre, // Preserve selected genre
            MovieRating = movieRating, // Preserve selected rating
